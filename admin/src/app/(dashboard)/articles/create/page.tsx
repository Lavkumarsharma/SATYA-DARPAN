          ...
          <div className="flex flex-col gap-3 justify-end">
            <label className="flex items-center gap-3 cursor-pointer group">
              <div
                ...
                className={`w-10 h-5 rounded-full transition-colors relative ${isFactCheck ? 'bg-accent' : 'bg-border'}`}
              >
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <div
                ...
                className={`w-10 h-5 rounded-full transition-colors relative ${isFeatured ? 'bg-accent' : 'bg-border'}`}
              >
